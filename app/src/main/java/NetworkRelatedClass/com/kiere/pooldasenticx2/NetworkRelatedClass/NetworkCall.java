...
public class NetworkCall {
    ...
    public static void fileUpload(String filePath) {
        ...
        RequestBody requestFile = RequestBody.create(file,MediaType.parse("multipart/form-data")); //allow image and any other file
...
//        String patientData = gson.toJson(imageSenderInfo);
       ...
       // RequestBody description = RequestBody.create(okhttp3.MultipartBody.FORM, patientData);
        ...
        Call<ResponseModel> call = apiInterface.fileUpload(body);
